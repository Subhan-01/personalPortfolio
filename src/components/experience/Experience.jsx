...
const Experience = () => {
  const education = [
    {
      ...
      place: "Iqra North Campus",
      desc: "Building a strong foundation in computer science principles and mastering core software engineering concepts through practical applications.",
    },
    {
      year: "2023 – 2025",
  ...
  return (
    ...
    <section id="experience" className="min-h-screen  text-gray-800 px-6 md:px-20 py-24 ">
